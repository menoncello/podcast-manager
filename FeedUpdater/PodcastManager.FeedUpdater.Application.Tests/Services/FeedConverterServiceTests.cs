...
public class FeedConverterServiceTests
{
            ...
            "https://killerinnovations.com")
        {
            Items = new []
            {
                new Item (
                    ...
                    "Phil McKinney",
                    new TimeSpan(0, 49, 06),
                    new Image("https://secureservercdn.net/104.238.68.130/afd.9e6.myftpupload.com/wp-content/uploads/powerpress/KI-logo-oneline-podcast-cover-wide-Square.jpg")),
                new Item (
                    "Ask Me Anything Q&A",
    ...
    {
        Action actNull = () => service.ConvertToDate(null!);
        Action actEmpty = () => service.ConvertToDate(string.Empty);
        Action actWhiteSpace = () => service.ConvertToDate("  ");
